<?php
/*
Template Name: Home Template Var B
*/
get_header(); ?>
        ...
        <?php while ( have_posts()) : the_post(); ?>
            ...
            <div class="container">
                <div class="holder-box variation-a">
                    <div class="wrap">
                        <h1>A simple hair test could change a life.</h1>
                        <h2>Accurate and effective testing for food intolerances.</h2>
                        <h3>Our tests are:</h3>
                        <ul>
                          <li>non-invasive (so great for babies and kids)</li>
                          <li>reliable</li>
                          <li>affordable</li>
                        </ul>
