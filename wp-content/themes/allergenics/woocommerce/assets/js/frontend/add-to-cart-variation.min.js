jQuery(document).ready(function($) {
	...
	$('form.variations_form')
		...
		.on( 'change', '.variations input:checkbox', function( event ) {

			$variation_form = $(this).closest('form.variations_form');
			$variation_form.find('input[name=variation_id]').val('').change();
			
			$variation_form
				.trigger( 'woocommerce_variation_checkbox_change' )
		...
		// Upon gaining focus
		.on( 'focusin', '.variations input:checkbox', function( event ) {

			$variation_form = $(this).closest('form.variations_form');

			$variation_form
				.trigger( 'woocommerce_variation_checkbox_focusin' )
		...
		.on( 'check_variations', function( event, exclude, focus ) {
			...
			$variation_form.find('.variations input:checkbox:checked').each( function() {
		...
		.on( 'update_variation_values', function( event, variations ) {
	        ...
	        $variation_form.find('.variations input:checkbox').each(function( index, el ){
	 ...
	 */
	$('form.variations_form .variations input:checkbox').change();
