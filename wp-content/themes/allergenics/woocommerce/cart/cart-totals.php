  ...
  <?php if($how_many_tests_in_cart > 0) { ?>
    <div class="urgent-box">
      <?php if($how_many_tests_in_cart == 1) { ?>
        ...
        <a href="<?php echo  $cart_url; ?>?add-to-cart=574&variation_id=719&attribute_amount=1">Yes please add urgent!</a>
      <?php } ?>
      ...
      <?php if($how_many_tests_in_cart == 2) { ?>
        <a href="<?php echo  $cart_url; ?>?add-to-cart=574&variation_id=720&attribute_amount=2">Yes please add urgent!</a>
      <?php } ?>
      
      <?php if($how_many_tests_in_cart == 3) { ?>
        <a href="<?php echo  $cart_url; ?>?add-to-cart=574&variation_id=721&attribute_amount=3">Yes please add urgent!</a>
      <?php } ?>
      
      <?php if($how_many_tests_in_cart == 4) { ?>
        <a href="<?php echo  $cart_url; ?>?add-to-cart=574&variation_id=722&attribute_amount=4">Yes please add urgent!</a>
      <?php } ?> 
    </div>
