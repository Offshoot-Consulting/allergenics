...
function redirect_form()
{
  ...
  $returnUrl =$server_url."/wp-content/plugins/paymentexpress/return2.php";

  # the following variables are read from the form
  $Quantity = "1";
  $MerchantReference = $_SESSION['fstname'].$_SESSION['lstname'];  
  $Address1 = "";
  $Address2 = "";
  $Address3 = "";
  
  #Calculate AmountInput
  $AmountInput = $_SESSION['amnt'];;
  ...
  $request->setEmailAddress("syedaliahmad@gmail.com");
  $request->setUrlFail($returnUrl);			# can be a dedicated failure page
  $request->setUrlSuccess($returnUrl);			# can be a dedicated success page
